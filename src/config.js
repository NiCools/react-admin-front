...
module.exports = {
  ...
  footer: '<a target="_blank" href="http://rulifun.com">weihome</a>版权所有 © 2017-2018',  // footer中显示的字, 可以嵌入html标签

  debug: true,  // 是否开启debug模式, 不会请求后端接口, 使用mock的数据

  tabMode: {  // tab模式相关配置
    enable: true,  // 是否开启tab模式
    allowDuplicate: false,  // 同一个菜单项允许多个tab
  },

  log: {
    level: 'info',  // 日志级别, 类似slf4j 中的root logger, 目前支持debug/info/warn/error 4种级别
